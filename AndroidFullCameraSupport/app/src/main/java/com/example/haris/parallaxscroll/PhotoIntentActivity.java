...
public class PhotoIntentActivity extends Activity {
    ...
    private static final int ACTION_PICK_FROM_GALLERY = 4;
    ...
    Button.OnClickListener mPickFromGalleryOnClickListener =
        new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        Button picGalleryBtn = (Button) findViewById(R.id.btnIntendG);
        setBtnListenerOrDisable(
                picGalleryBtn,
                mPickFromGalleryOnClickListener,
                MediaStore.ACTION_IMAGE_CAPTURE
        );
    ...
    private void handleGallery(Intent data) throws IOException {
        ...
        BitmapFactory.Options bmOptions = new BitmapFactory.Options();
        bmOptions.inJustDecodeBounds = true;
        BitmapFactory.decodeFile(selectedImageUri.getPath(), bmOptions);
